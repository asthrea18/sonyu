...
<html lang="ko">
   <head>
      <title>소녀나라 - 스커트</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 스커트" />
      <meta name="subject" content="스커트" />
      <meta name="description" content="스커트,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
...
<!-- 				</li> -->
         ...
         <section id="container" class="subpage">
            ...
            <div class="contents">
               <div style="text-align: center; position: relative; display: none;margin-bottom:80px;">
                  <img src="https://img.sonyunara.com/files/cateimage/0202.gif" onerror="$(this).remove();" onload="$(this).closest('div').show();" />
               </div>
               <h2 class="">스커트</h2>
               <div class="category-product">
                  <ul class="tabmenu">
                     <li class='on'><a class="" href="/shop/list.php?cate=0202">All</a></li>
                  </ul>
                  <!-- //tabmenu -->
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=67154">쫀쫀모직치마바지(SK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 159</span>
                                       <span>리뷰 4</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=58464">제인테니스스커트(SK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 9037</span>
                                       <span>리뷰 122</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=47321">[무료배송]마카롱테니스스커트(SK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 8686</span>
                                       <span>리뷰 126</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=64570">데일리모던스커트(SK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 4058</span>
                                       <span>리뷰 8</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=59896" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/59896/1585114536_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(59896);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>21<em>%</em></span>												<span>9,500</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=59896">사이드트임롱스커트(SK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 4060</span>
                                       <span>리뷰 74</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>157개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=0202">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0202&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0202&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0202&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=0202&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [67740,67502,67452] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
