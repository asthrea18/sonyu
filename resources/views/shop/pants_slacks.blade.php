...
<html lang="ko">
   <head>
      <title>소녀나라 - 슬랙스</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 슬랙스" />
      <meta name="subject" content="슬랙스" />
      <meta name="description" content="슬랙스,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
...
<!-- 				</li> -->
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     ...
                     <li class="on"><a class="" href="/shop/list.php?cate=020106">슬랙스</a></li>
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>34<em>%</em></span>												<span>15,900</span>
                                       </div>
                                       <div class="pull-right">
                                          오늘출발
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=54016">(기모추가)한끗차이 쫀쫀롱슬랙스 (7colors!)[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 5040</span>
                                       <span>리뷰 49</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=57950" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/57950/1579597420_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(57950);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>27<em>%</em></span>												<span>20,500</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=57950">모렌티부츠컷팬츠(PA)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 2516</span>
                                       <span>리뷰 34</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>9개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=020106">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020106&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020106&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020106&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=020106&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [66656,54014,59277] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
