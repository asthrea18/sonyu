...
<html lang="ko">
   <head>
      <title>소녀나라 - 레깅스</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 레깅스" />
      <meta name="subject" content="레깅스" />
      <meta name="description" content="레깅스,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
      ...
      <div class="wrap">
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     ...
                     <li class="on"><a class="" href="/shop/list.php?cate=020105">레깅스</a></li>
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=40339" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/40339/1538101793_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(40339);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=40339">(재입고)갑질속바지[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 20417</span>
                                       <span>리뷰 237</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=34123" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/34123/1597988326_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(34123);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>32<em>%</em></span>												<span>9,800</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=34123">아무르레깅스[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 12073</span>
                                       <span>리뷰 102</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=35813" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/35813/1599103416_5.jpg.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(35813);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>37<em>%</em></span>												<span>9,800</span>
                                       </div>
                                       <div class="pull-right">
                                          오늘출발
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=35813">뉴킨킨레깅스[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 76289</span>
                                       <span>리뷰 687</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=37043" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/37043/1597987875_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(37043);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=37043">(재입고)워너레터링레깅스[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 9179</span>
                                       <span>리뷰 91</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>12개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=020105">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020105&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020105&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020105&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=020105&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [66960,35813,67044] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
