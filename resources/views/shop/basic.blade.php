...
<html lang="ko">
   <head>
      <title>소녀나라 - 베이직</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 베이직" />
      <meta name="subject" content="베이직" />
      <meta name="description" content="베이직,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
...
<!-- 				</li> -->
         ...
         <section id="container" class="subpage">
            ...
            <div class="contents">
               <div style="text-align: center; position: relative; display: none;margin-bottom:80px;">
                  <img src="https://img.sonyunara.com/files/cateimage/0407.gif" onerror="$(this).remove();" onload="$(this).closest('div').show();" />
               </div>
               <h2 class="">베이직</h2>
               <div class="category-product">
                  <ul class="tabmenu">
                     <li class='on'><a class="" href="/shop/list.php?cate=0407">All</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=040701">상의</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=040702">하의</a></li>
                  </ul>
                  <!-- //tabmenu -->
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=67090" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/67090/1608107884_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(67090);">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>38<em>%</em></span>												<span>9,800</span>
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=67090">[기획]따뜻해와이드골지팬츠(겉기모)(PA)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 745</span>
                                       <span>리뷰 5</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=54850" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/54850/1606983389_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(54850);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>29<em>%</em></span>												<span>9,800</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=54850">(기획특가)매일매일수면바지(TR)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 8390</span>
                                       <span>리뷰 213</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66106" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66106/1603861517_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66106);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66106">[1+1기획]슬림골지폴라니트2종(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 9405</span>
                                       <span>리뷰 73</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66960" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66960/1605861701_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66960);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>39<em>%</em></span>												<span>9,800</span>
                                       </div>
                                       <div class="pull-right">
                                          오늘출발
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66960">HOT트텍♨이너웨어 2종[핫트텍](T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 694</span>
                                       <span>리뷰 25</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66958" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66958/1605861977_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66958);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66958">쫀쫀치마바지(겉기모)(SK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 208</span>
                                       <span>리뷰 6</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>25<em>%</em></span>												<span>7,900</span>
                                       </div>
                                       <div class="pull-right">
                                          오늘출발
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=42223">[고퀄제작]레이어드 무지티셔츠 (150/160 사이즈) [P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 71235</span>
                                       <span>리뷰 644</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>311개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=0407">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0407&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0407&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0407&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=0407&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [67794,66308,67800] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
