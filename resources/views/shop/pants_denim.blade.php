...
<html lang="ko">
   <head>
      <title>소녀나라 - 팬츠/데님</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 팬츠/데님" />
      <meta name="subject" content="팬츠/데님" />
      <meta name="description" content="팬츠/데님,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
      ...
      <div class="wrap">
         ...
         <section id="container" class="subpage">
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     <li class="on"><a class="" href="/shop/list.php?cate=0201">All</a></li>
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66602" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66602/1605595618_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66602);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66602">루미코듀로이팬츠 (12colors!)(PA)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 953</span>
                                       <span>리뷰 6</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>405개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=0201">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0201&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0201&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=0201&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=0201&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [66910,67912,67618] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
