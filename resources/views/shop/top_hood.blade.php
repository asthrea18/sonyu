...
<html lang="ko">
   <head>
      ...
      <meta name="title" content="소녀나라 - 후드" />
      <meta name="subject" content="후드" />
      <meta name="description" content="후드,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
      ...
      <div class="wrap">
         ...
         <section id="container" class="subpage">
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     <li class=''><a class="" href="/shop/list.php?cate=0101">All</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=010102">긴팔티셔츠</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=010104">맨투맨</a></li>
                     <li class='on'><a class="" href="/shop/list.php?cate=010103">후드</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=010101">반팔/민소매티셔츠</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=010105">니트</a></li>
                     <li class=''><a class="" href="/shop/list.php?cate=010106">브랜드상의</a></li>
                  </ul>
                  <!-- //tabmenu -->
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=67160" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/67160/1606808880_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(67160);">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=67160">호킨스레이어후드티(기모)(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 53</span>
                                    </div>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=67136" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/67136/1607049899_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(67136);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=67136">캥거루포켓후드(기모)(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 122</span>
                                       <span>리뷰 2</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66826" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66826/1605077938_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66826);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66826">소울메이트후드(기모)(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 312</span>
                                       <span>리뷰 4</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=57484" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/57484/1578987774_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(57484);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>12<em>%</em></span>												<span>22,000</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=57484">오버핏벌룬소매후드(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 3614</span>
                                       <span>리뷰 75</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=65960" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/65960/1605233927_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(65960);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=65960">[프리미엄급!]멈블투기모후드(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 972</span>
                                       <span>리뷰 12</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66402" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66402/1603693207_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66402);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66402">[신상반응폭주]몽글뽀글이후드(T)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 274</span>
                                       <span>리뷰 2</span>
                  ...
                  <div class="list-info-box">
                     ...
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=010103">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=010103&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=010103&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=010103&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=010103&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [53670,67258,67160] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
