...
<html lang="ko">
   <head>
      <title>소녀나라 - 숏팬츠</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 숏팬츠" />
      <meta name="subject" content="숏팬츠" />
      <meta name="description" content="숏팬츠,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
      ...
      <div class="wrap">
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     ...
                     <li class="on"><a class="" href="/shop/list.php?cate=020101">숏팬츠</a></li>
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>17<em>%</em></span>												<span>12,500</span>
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=64170">수술컷팅4부팬츠[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 364</span>
                                       <span>리뷰 3</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>33<em>%</em></span>												<span>24,900</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=62744">쓰리피스트레이닝세트(TR)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 1102</span>
                                       <span>리뷰 7</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=51340">[무료배송]애쉬필드멜빵팬츠(PA)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 2378</span>
                                       <span>리뷰 64</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=48585">제로트레이닝팬츠(PA)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 3314</span>
                                       <span>리뷰 65</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=40507" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/40507/1597997634_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(40507);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>66<em>%</em></span>												<span>10,000</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=40507">[한정세일]쫙빠진 슬림핫팬츠(BK)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 3347</span>
                                       <span>리뷰 16</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>60개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=020101">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020101&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020101&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020101&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=020101&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [33383,40507,62744] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
