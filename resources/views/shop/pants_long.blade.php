...
<html lang="ko">
   <head>
      <title>소녀나라 - 롱팬츠</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 롱팬츠" />
      <meta name="subject" content="롱팬츠" />
      <meta name="description" content="롱팬츠,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
      ...
      <div class="wrap">
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     ...
                     <li class="on"><a class="" href="/shop/list.php?cate=020102">롱팬츠</a></li>
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=66438" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/66438/1604535894_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(66438);">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=66438">[기획특가]르벨코듀로이 밴딩팬츠(PA)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 1659</span>
                                       <span>리뷰 19</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=65032" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/65032/1603171817_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(65032);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=65032">[기획]인생핏 빅체크밴딩팬츠 140/150/160/170[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 5651</span>
                                       <span>리뷰 75</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=51177" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/51177/1599025706_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(51177);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=51177">[무료배송][단독기획]와이드골지팬츠(찰랑) 150/160/170[P]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 52976</span>
                                       <span>리뷰 761</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>306개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=020102">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020102&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020102&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020102&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=020102&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [67912,66578,67618] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
