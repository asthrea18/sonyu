...
<html lang="ko">
   <head>
      <title>소녀나라 - 운동화·단화</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 운동화·단화" />
      <meta name="subject" content="운동화·단화" />
      <meta name="description" content="운동화·단화,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
      ...
      <div class="wrap">
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     ...
                     <li class='on'><a class="" href="/shop/list.php?cate=050101">운동화·단화</a></li>
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>72<em>%</em></span>												<span>13,800</span>
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=53822">[SNRD]스니커즈(SN152)[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 5865</span>
                                       <span>리뷰 185</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>70<em>%</em></span>												<span>14,800</span>
                                       </div>
                                       <div class="pull-right">
                                          오늘출발
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=53994">[SNRD]벨크로 스니커즈(SN153)[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 1579</span>
                                       <span>리뷰 40</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=55574">[SNRD] 겨울 단화 보아털 안감 군밤스니커즈 (SN520)[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 1168</span>
                                       <span>리뷰 27</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=48709" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/48709/1554440770_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(48709);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>38<em>%</em></span>												<span>19,800</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=48709">스웨이드운동화(SH)</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 1593</span>
                                       <span>리뷰 49</span>
                  ...
                  <div class="list-info-box">
                     <div class="txt"><strong>45개의 상품</strong></div>
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=050101">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=050101&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=050101&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=050101&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=050101&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [53996,56900,53994] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
