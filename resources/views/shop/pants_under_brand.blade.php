...
<html lang="ko">
   <head>
      <title>소녀나라 - 브랜드하의</title>
      <meta name="build" content="" />
      <meta name="title" content="소녀나라 - 브랜드하의" />
      <meta name="subject" content="브랜드하의" />
      <meta name="description" content="브랜드하의,당일배송여성쇼핑몰,소녀나라,소나,10대여자쇼핑몰,여자여름코디,키작녀쇼핑몰,10대쇼핑몰" />
...
<!-- 				</li> -->
            ...
            <div class="contents">
               ...
               <div class="category-product">
                  <ul class="tabmenu">
                     ...
                     <li class="on"><a class="brand" href="/shop/list.php?cate=020108">브랜드하의</a></li>
                  </ul>
                  <!-- //tabmenu -->
                           ...
                           <ul class="item" id="swiper-container-list-ranking">
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=65640">[무료배송][FCMM]클럽 에센셜 팬츠[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 204</span>
                                       <span>리뷰 1</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>58<em>%</em></span>												<span>16,800</span>
                                       </div>
                                       <div class="pull-right">
                                          오늘출발
                                       </div>
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=63436">[나이키]스우시 반바지 (주문폭주 인기상품) *여름마지막할인[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 2228</span>
                                       <span>리뷰 48</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    ...
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=58392">[무료배송][FCMM]클럽 사이드라인 크롭 트랙팬츠[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 562</span>
                                       <span>리뷰 11</span>
                              ...
                              <li class="slick-slide">
                                 ...
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>57<em>%</em></span>												<span>18,800</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=58330">[무료배송][오프위]뉴문 조거팬츠[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 1265</span>
                                       <span>리뷰 25</span>
                              ...
                              <li class="slick-slide">
                                 <div class="item-image">
                                    ...
                                    <a href="/shop/view.php?index_no=58324" class="image">
                                       <img src="https://img.sonyunara.com/files/goods/58324/1580982277_5.gif.webp">
                                       <!-- 												<img class="list_show_icon" src="https://img.sonyunara.com/2020/icon/best_icon.png" alt=""> -->
                                    </a>
                                    <a href="javascript:;" class="good " onclick="GoodsProc.new_set_wish_single(58324);">
                                       <!-- 											<i class="fa fa-heart"></i> -->
                                    </a>
                                 </div>
                                 <div class="item-content">
                                    <div class="info">
                                       <div class="pull-left">
                                          <span>55<em>%</em></span>												<span>19,800</span>
                                       </div>
                                    </div>
                                    <div class="subject">
                                       <a href="/shop/view.php?index_no=58324">[무료배송][오프위]SIMPLY 와이드롱팬츠[B]</a>
                                    </div>
                                    <div class="count">
                                       <span>구매 777</span>
                                       <span>리뷰 17</span>
                  ...
                  <div class="list-info-box">
                     ...
                     <ul class="list-sort">
                        <li class="on"><a href="/shop/list.php?page=1&cate=020108">추천순</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020108&orby=1">신상품</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020108&orby=2">판매량</a></li>
                        <li class=""><a href="/shop/list.php?page=1&cate=020108&orby=3">낮은가격</a></li>
                        <!-- <li class=""><a href="/shop/list.php?page=1&cate=020108&orby=4">높은가격</a></li> -->
                     </ul>
                  </div>
                  <!-- //list-info-box -->
         ...
         <script type="text/javascript">
            ...
            window.criteo_q.push(
             ...
             { event: "viewList", item: [61308,59836,59822] }); // 가장 위에있는 3개의 상품 ID를 전달
         </script>
